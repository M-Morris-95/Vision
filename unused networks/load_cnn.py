...
EPOCHS = 0
ROOT_PATH = os.getcwd()
IMAGES_PATH = '/home/tbd/Documents/Vision'

test_data, test_labels = images_to_tensors(IMAGES_PATH + '/classification_images/test_data')
...
model.save_weights('Initial_CNN.hdf5')
